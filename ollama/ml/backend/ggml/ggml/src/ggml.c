...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO] = {
        .type_name                = "turbo",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbo),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo_ref,
    },
    [GGML_TYPE_IQ2_S] = {
        .type_name                = "iq2_s",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_TURBO:   result = quantize_turbo(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_F16:
            {
